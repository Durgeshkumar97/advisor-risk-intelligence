...
/**
 * ITU-T E.164 country calling codes, used to render the country-code
 * selector next to every phone input in the product. 'default' is what the
 * selector is pre-set to (RiskSignal's advisor base is overwhelmingly
 * Indian), but every country is selectable — this is not India-only
 * validation, just a sensible default.
 */
return [
