...
<section style="padding:5rem 1rem;">
    ...
    <div style="max-width:600px;margin:auto;text-align:center;">
        ...
        <div style="width:72px;height:72px;margin:0 auto 1.5rem;border-radius:50%;background:rgba(250,204,21,.1);border:2px solid rgba(250,204,21,.25);display:flex;align-items:center;justify-content:center;font-size:2rem;">⚡</div>
        ...
        <div class="card" style="margin:2rem auto;padding:1.75rem;text-align:left;max-width:420px;">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1rem;">
                ...
                <span style="display:inline-block;padding:.3rem .9rem;border-radius:999px;background:rgba(16,185,129,.15);color:#34d399;font-size:.8rem;font-weight:700;text-transform:uppercase;">
            ...
            <div style="margin-top:1rem;padding-top:1rem;border-top:1px solid var(--paper-3);font-size:.875rem;color:var(--ink-3);">
                @php $endDate = $subscription->ends_at ?? $subscription->trial_ends_at; @endphp
                Renews / expires: <strong style="color:inherit;">{{ $endDate->format('d M Y') }}</strong>
                &nbsp;·&nbsp;
        ...
        <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;margin-top:1rem;">
            ...
            <a href="{{ route('subscription.index') }}" style="padding:.9rem 1.75rem;border-radius:12px;border:1px solid var(--paper-3);color:var(--ink-3);font-weight:600;font-size:.95rem;text-decoration:none;transition:.15s ease;"
        ...
        <div style="margin-top:2rem;padding:1.25rem;border-radius:14px;background:rgba(250,204,21,.06);border:1px solid rgba(250,204,21,.15);font-size:.875rem;line-height:1.6;">
            <strong style="color:var(--gold);">Interested in upgrading to {{ $plan->name }}?</strong><br>
            <span style="color:var(--ink-3);">
                Please cancel your current plan first, then purchase the new one. Or email
