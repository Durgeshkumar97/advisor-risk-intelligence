...
<head>
    ...
    <style>
        :root{--bg:#020817;--panel:#0f172a;--line:rgba(255,255,255,.08);--muted:#64748b;--soft:#94a3b8;--white:#fff;--gold:#facc15;--green:#22c55e;--blue:#2563eb;--danger:#ef4444;}
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .nav-link{color:var(--soft);text-decoration:none;font-size:13px;font-weight:600;padding:6px 14px;border-radius:8px;border:1px solid transparent;}
        .nav-link:hover{border-color:var(--line);color:var(--white);}
...
<div class="container">
    ...
    <div class="topbar">
        <div>
            ...
            <h1>Users</h1>
            <p class="subtitle">{{ $users->total() }} total users registered</p>
        </div>
        <div class="actions">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if(!$sub)
                            <span class="badge badge-none">No sub</span>
                        ...
                        @else
                            <span class="badge badge-expired">{{ ucfirst($sub->status) }}</span>
                        @endif
                    </td>
                    ...
                    <td>
                        <a href="{{ route('admin.users.show', $user->id) }}" style="color:#a5b4fc;font-size:13px;font-weight:700;text-decoration:none;white-space:nowrap;">
                            View →
                        </a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="9" style="text-align:center;padding:3rem;color:var(--muted);">No users found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
